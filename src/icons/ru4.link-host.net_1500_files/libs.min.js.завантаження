(function e$$0(h,c,l){function k(d,a){if(!c[d]){if(!h[d]){var b="function"==typeof require&&require;if(!a&&b)return b(d,!0);if(e)return e(d,!0);b=Error("Cannot find module '"+d+"'");throw b.code="MODULE_NOT_FOUND",b;}b=c[d]={exports:{}};h[d][0].call(b.exports,function(a){var b=h[d][1][a];return k(b?b:a)},b,b.exports,e$$0,h,c,l)}return c[d].exports}for(var e="function"==typeof require&&require,f=0;f<l.length;f++)k(l[f]);return k})({1:[function(n,h,c){function l(a){return a.replace(g,"&lt;").replace(p,
"&gt;")}function k(a){return a.replace(m,"&quot;")}function e(a){return a.replace(y,'"')}function f(a){return a.replace(t,function(a,b){return"x"===b[0]||"X"===b[0]?String.fromCharCode(parseInt(b.substr(1),16)):String.fromCharCode(parseInt(b,10))})}function d(a){return a.replace(q,":").replace(z," ")}function a(a){for(var b="",d=0,c=a.length;d<c;d++)b+=32>a.charCodeAt(d)?" ":a.charAt(d);return b.trim()}function b(b){b=e(b);b=f(b);b=d(b);return b=a(b)}function v(a){a=k(a);return a=l(a)}var g=/</g,
p=/>/g,m=/"/g,y=/&quot;/g,t=/&#([a-zA-Z0-9]*);?/img,q=/&colon;?/img,z=/&newline;?/img,w=/\/\*|\*\//mg,r=/((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a)\:/ig,x=/e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/ig,s=/u\s*r\s*l\s*\(.*/ig,u=/\x3c!--[\s\S]*?--\x3e/g;c.whiteList={a:["target","href","title"],abbr:["title"],address:[],area:["shape","coords","href","alt"],article:[],aside:[],b:[],bdi:["dir"],bdo:["dir"],big:[],blockquote:["cite"],br:[],caption:[],center:[],
cite:[],code:[],col:["align","valign","span","width"],colgroup:["align","valign","span","width"],dd:[],del:["datetime"],details:["open"],div:["style","class"],dl:[],dt:[],em:[],font:["color","size","face"],footer:[],h1:[],h2:[],h3:[],h4:[],h5:[],h6:[],header:[],hr:[],i:[],ins:["datetime"],li:[],label:["class"],mark:[],nav:[],ol:[],p:["class"],pre:[],s:[],section:[],small:[],span:["class"],sub:[],sup:[],strong:[],table:["width","border","align","valign"],tbody:["align","valign"],td:["width","colspan",
"align","valign"],tfoot:["align","valign"],th:["width","colspan","align","valign"],thead:["align","valign"],tr:["rowspan","align","valign"],tt:[],u:[],ul:[]};c.onTag=function(a,b,d){};c.onIgnoreTag=function(a,b,d){};c.onTagAttr=function(a,b,d){};c.onIgnoreTagAttr=function(a,b,d){};c.safeAttrValue=function(a,d,c){c=b(c);if("href"===d||"src"===d){c=c.trim();if("#"===c)return"#";if("http://"!==c.substr(0,7)&&"https://"!==c.substr(0,8)&&"mailto:"!==c.substr(0,7)&&"/"!==c[0])return""}else if("background"===
d){if(r.lastIndex=0,r.test(c))return""}else if("style"===d){w.lastIndex=0;if(w.test(c))return"";x.lastIndex=0;if(x.test(c))return"";s.lastIndex=0;if(s.test(c)&&(r.lastIndex=0,r.test(c)))return""}return c=v(c)};c.escapeHtml=l;c.escapeQuote=k;c.unescapeQuote=e;c.escapeHtmlEntities=f;c.escapeDangerHtml5Entities=d;c.clearNonPrintableCharacter=a;c.friendlyAttrValue=b;c.escapeAttrValue=v;c.onIgnoreTagStripAll=function(){return""};c.StripTagBody=function(a,b){"function"!==typeof b&&(b=function(){});var d=
!Array.isArray(a),c=[],k=!1;return{onIgnoreTag:function(g,f,e){var m;m=d?!0:-1!==a.indexOf(g);if(m){if(e.isClosing)return c.push([!1!==k?k:e.position,e.position+10]),k=!1,"[/removed]";k||(k=e.position);return"[removed]"}return b(g,f,e)},remove:function(a){var b="",d=0;c.forEach(function(c){b+=a.slice(d,c[0]);d=c[1]});return b+=a.slice(d)}}};c.stripCommentTag=function(a){return a.replace(u,"")}},{}],2:[function(n,h,c){var l=n("./default"),k=n("./parser"),e=n("./xss");c=h.exports=function(d,a){return(new e(a)).process(d)};
c.FilterXSS=e;for(var f in l)c[f]=l[f];for(f in k)c[f]=k[f];"undefined"!==typeof window&&(Array.prototype.indexOf||(Array.prototype.indexOf=function(d){for(var a=0;a<this.length;a++)if(this[a]==d)return a;return-1}),Array.prototype.forEach||(Array.prototype.forEach=function(d,a){for(var b=0;b<this.length;b++)d.call(a,this[b],b,this)}),String.prototype.trim||(String.prototype.trim=function(){return this.replace(/(^\s*)|(\s*$)/g,"")}),window.filterXSS=h.exports)},{"./default":1,"./parser":3,"./xss":4}],
3:[function(n,h,c){var l=/[^a-zA-Z0-9_:\.\-]/img;c.parseTag=function(c,e,f){"user strict";for(var d="",a=0,b=!1,l=!1,g=0,p=c.length,m="",h="",g=0;g<p;g++)if(m=c.charAt(g),!1===b)"<"===m&&(b=g);else if(!1===l)if("<"===m)d+=f(c.slice(a,g)),a=b=g;else if(">"===m)d+=f(c.slice(a,b)),a=m=c.slice(b,g+1),h=a.indexOf(" "),a=-1===h?a.slice(1,-1):a.slice(1,h+1),a=a.trim().toLowerCase(),"/"===a[0]&&(a=a.slice(1)),"/"===a[a.length-1]&&(a=a.slice(0,-1)),h=a,d+=e(b,d.length,h,m,"</"===m.slice(0,2)),a=g+1,b=!1;else{if('"'===
m||"'"===m)l=m}else m===l&&(l=!1);a<c.length&&(d+=f(c.substr(a)));return d};c.parseAttr=function(c,e){function f(b,c){b=b.trim();b=b.replace(l,"").toLowerCase();1>b.length||a.push(e(b,c||""))}"user strict";for(var d=0,a=[],b=!1,h=c.length,g=0;g<h;g++){var p=c.charAt(g);if(!1===b&&"="===p)b=c.slice(d,g),d=g+1;else{if(!1!==b&&g===d&&('"'===p||"'"===p))if(g=c.indexOf(p,g+1),-1===g)break;else{d=c.slice(d+1,g).trim();f(b,d);b=!1;d=g+1;continue}" "===p&&(d=c.slice(d,g).trim(),!1===b?f(d):f(b,d),b=!1,d=
g+1)}}d<c.length&&(!1===b?f(c.slice(d)):f(b,c.slice(d)));return a.join(" ").trim()}},{}],4:[function(n,h,c){function l(a){var b=a.indexOf(" ");if(-1===b)return{html:"",closing:"/"===a[a.length-2]};a=a.slice(b+1,-1).trim();(b="/"===a[a.length-1])&&(a=a.slice(0,-1).trim());return{html:a,closing:b}}function k(a){a=a||{};a.stripIgnoreTag&&(a.onIgnoreTag&&console.error('Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'),a.onIgnoreTag=e.onIgnoreTagStripAll);a.whiteList=
a.whiteList||e.whiteList;a.onTag=a.onTag||e.onTag;a.onTagAttr=a.onTagAttr||e.onTagAttr;a.onIgnoreTag=a.onIgnoreTag||e.onIgnoreTag;a.onIgnoreTagAttr=a.onIgnoreTagAttr||e.onIgnoreTagAttr;a.safeAttrValue=a.safeAttrValue||e.safeAttrValue;a.escapeHtml=a.escapeHtml||e.escapeHtml;this.options=a}var e=n("./default");n=n("./parser");var f=n.parseTag,d=n.parseAttr;k.prototype.process=function(a){var b=this.options,c=b.whiteList,g=b.onTag,h=b.onIgnoreTag,k=b.onTagAttr,n=b.onIgnoreTagAttr,t=b.safeAttrValue,q=
b.escapeHtml;b.allowCommentTag||(a=e.stripCommentTag(a));b.stripIgnoreTagBody?(b=e.StripTagBody(b.stripIgnoreTagBody,h),h=b.onIgnoreTag):b=!1;a=f(a,function(a,b,e,f,s){a={sourcePosition:a,position:b,isClosing:s,isWhite:e in c};b=g(e,f,a);if(void 0!==b&&null!==b)return b;if(a.isWhite){if(a.isClosing)return"</"+e+">";a=l(f);var u=c[e];b=d(a.html,function(a,b){var c=-1!==u.indexOf(a),d=k(e,a,b,c);if(void 0!==d&&null!==d)return d;if(c)return(b=t(e,a,b))?a+'="'+b+'"':a;d=n(e,a,b,c);if(void 0!==d&&null!==
d)return d});f="<"+e;b&&(f+=" "+b);a.closing&&(f+=" /");return f+">"}b=h(e,f,a);return void 0!==b&&null!==b?b:q(f)},q);b&&(a=b.remove(a));return a};h.exports=k},{"./default":1,"./parser":3}]},{},[2]);
